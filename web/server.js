...
var server = https.createServer(sslOptions, app).listen(port, function(){
  ...
  app.get('/monitorD', function (req, res) {
    res.sendFile(`${base}/monitorD.html`);
  });
  app.get('/dev_prefer', function (req, res) {
    res.sendFile(`${base}/dev_prefer.html`);
  });
  app.get('/removeDev', function (req, res) {
    res.sendFile(`${base}/removeDev.html`);
  });
  app.get('/lighting', function (req, res) {
    res.sendFile(`${base}/lighting.html`);
  });
  app.get('/airconditioning', function (req, res) {
